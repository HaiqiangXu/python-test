...
def create_dice():
    ...
    dice.append(draw_dice('dot1', 'dot2', 'dot4',
                          'dot6', 'dot9'))  # dice head 5
    dice.append(draw_dice('dot1', 'dot2', 'dot3',
                          'dot5', 'dot6', 'dot9'))  # dice head 6
    return dice
...
def draw_dice(*args):
    ...
    for arg in args:
        # Gets the dictionary keys while passing in x, y, and r values
        dots.get(arg)(x, y, r)
